...
mindmaps.SaveDocumentPresenter = function(eventBus, mindmapModel, view, autosaveController, filePicker) {
  ...
  */
  view.fileContentsRequested = function() {
    ...
    //window.parent.document.getElementById('temp1_area').value=JSON.stringify(str);
var idarray="";
...
//alert(idarray);
     $.ajax({
          ...
          dataType : "json",
          data: ( { "json" : str} ),
          success: function(msg) {console.log(msg);savejson(msg);window.parent.document.getElementById('temp1_area').value=JSON.stringify(str);},
          complete: function(){},
