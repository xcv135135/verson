...
var json = decodeURI(a);
    ...
    for(i=1;i<nodecaptionarray.length;i++)
    {
        ...
        if(parseInt(document.getElementById(nodeparentidarray[i]).childNodes.length)<nodecaptionarray.length)
        {
           ...
           /* var sp1 = document.createElement("ol");
            sp1.className="dd-list";
            // Get a reference to the element, before we want to insert the element
            var sp2 = document.getElementById(nodeparentidarray[i]);
           ...
           //document.getElementById(nodeparentidarray[i]).parentNode.appendChild("<ol class='dd-list'></ol>");
       //     $("#"+nodeparentidarray[i]).append("<ol class='dd-list'>");

             //$("#"+nodeparentidarray[i]).append("<ol class='dd-list'><li class='dd-item'><div class='dd-handle' id='"+nodeidarray[i]+"'>"+nodecaptionarray[i]+"</div></li></ol>");
...
//$("#test").append("<li class='dd-item'><div class='dd-handle' id='"+nodeidarray[i]+"'>"+nodecaptionarray[i]+"</div></li>");
		  ...
		  <div class="row">
            ...
            <form class="form-search">
				  <div class="input-group">
                      ...
                      -->
                 <div class="container" id="conceptBody" onContextMenu="return false" >
            <!-- demo -->
