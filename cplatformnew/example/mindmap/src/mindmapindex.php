...
<div id="save-dialog" class="file-dialog" title="儲存心智圖">
  
 
  <p>將mindmap 圖儲存並且前往node link 圖</p>
  <div id="button-save-hdd" tyle="width:38px">save</div>
</div>
</script>
...
<body>
  ...
  <script src="js/filepicker1.js"></script>
